        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-[#6d412a]/70 leading-relaxed max-w-2xl mx-auto mb-10">
              ...
              Automatic, compliant, and built to scale.
            </p>
      ...
      <section className="py-24 bg-[#fdf8f4]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-[#6d412a]/70 max-w-2xl mx-auto">
              From post-game stadium kitchens to end-of-service restaurant prep, and the nonprofits who distribute it all.
            ...
            <div>
              ...
              <ul className="space-y-4 mb-10">
                {[
                  ...
                  "Unsold items auto-route to nonprofits, so nothing is wasted",
                ].map((point) => (
