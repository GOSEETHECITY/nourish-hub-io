...
import { ArrowRight, Building2, UtensilsCrossed, Heart, BarChart3, Leaf, Users, ChevronRight } from "lucide-react";
...
const sellSteps = [
  ...
  { num: "02", title: "Consumers purchase", desc: "Local consumers buy discounted meals or items through the app before your close. Real revenue, zero waste." },
  ...
  return (
    <div className="min-h-screen bg-[#fdf8f4]">
      ...
      <section className="relative overflow-hidden bg-[#2a1a10] text-white">
        <div className="absolute inset-0 bg-gradient-to-br from-[#3a2617] via-[#2a1a10] to-[#1a0f07]" />
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-20 left-1/4 w-96 h-96 rounded-full bg-[#6d412a] blur-3xl" />
          <div className="absolute bottom-10 right-1/4 w-72 h-72 rounded-full bg-[#8B5E3C] blur-3xl" />
        </div>

        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-32">
          <div className="max-w-4xl">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#6d412a]/30 border border-[#6d412a]/50 text-[#c8956a] text-sm font-medium mb-8">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold leading-tight tracking-tight mb-6">
              ...
              <span className="text-[#c8956a]">go to waste.</span>
            </h1>

            <p className="text-xl text-white/70 leading-relaxed max-w-2xl mb-10">
              Hariet.AI connects venues, restaurants, and institutions with the communities and consumers who need their surplus most — automatically, compliantly, and at scale.
            </p>

            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                to="/contact"
                className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-[#6d412a] text-white font-semibold hover:bg-[#5a3422] transition shadow-lg"
              >
                Get Started <ArrowRight className="w-4 h-4" />
              </Link>
              <Link
                to="/solutions"
                className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl border border-white/20 text-white font-semibold hover:bg-white/5 transition"
              >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-white/10">
              {stats.map((s) => (
                <div key={s.label} className="py-6 px-8 text-center">
                  <div className="text-3xl font-bold text-[#c8956a] mb-1">{s.value}</div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[#2a1a10] mb-4">One platform. Two pathways.</h2>
            <p className="text-lg text-[#6d412a]/80 max-w-2xl mx-auto">
              Every venue operates differently. Hariet.AI handles both — whether you donate everything or sell surplus before donating the rest.
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-8">
            {/* Donate Pathway */}
            <div className="rounded-3xl bg-[#fdf8f4] border border-[#e8e0d8] p-8">
              ...
              <h3 className="text-2xl font-bold text-[#2a1a10] mb-2">Donate your surplus</h3>
              <p className="text-[#6d412a]/70 mb-8">
                For stadiums, arenas, convention centers, and institutions that route all surplus directly to nonprofit partners — no consumer transactions, no complexity.
              </p>
              ...
              <div className="space-y-6">
                {donateSteps.map((step) => (
                  <div key={step.num} className="flex gap-4">
                    ...
                    <div>
                      <div className="font-semibold text-[#2a1a10] mb-1">{step.title}</div>
              ...
              <div className="mt-8 pt-6 border-t border-[#e8e0d8]">
                <p className="text-xs font-semibold text-[#6d412a]/60 uppercase tracking-wide mb-3">Best for</p>
            ...
            {/* Sell + Donate Pathway */}
            <div className="rounded-3xl bg-[#2a1a10] text-white p-8">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 text-white/80 text-xs font-semibold tracking-wide uppercase mb-6">
                <BarChart3 className="w-3.5 h-3.5" />
                Sell + Donate Pathway
              </div>
              <h3 className="text-2xl font-bold mb-2">Sell surplus. Donate the rest.</h3>
              <p className="text-white/60 mb-8">
                For restaurants, cafes, and hospitality venues that want to recover revenue on same-day surplus — then donate whatever doesn't sell.
              </p>

              <div className="space-y-6">
                {sellSteps.map((step) => (
                  <div key={step.num} className="flex gap-4">
                    <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-[#c8956a] text-white text-sm font-bold flex items-center justify-center">
                      {step.num}
                    </div>
                    <div>
      ...
      <section className="py-24 bg-[#fdf8f4]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[#2a1a10] mb-4">Built for every venue that serves food</h2>
            <p className="text-lg text-[#6d412a]/80 max-w-2xl mx-auto">
              From post-game stadium kitchens to end-of-service restaurant prep — Hariet.AI fits your operation.
            </p>
          </div>

          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {industries.map((ind) => (
              <div key={ind.title} className="bg-white rounded-2xl border border-[#e8e0d8] p-6 hover:border-[#6d412a]/30 hover:shadow-md transition group">
                ...
                <h3 className="font-bold text-[#2a1a10] mb-2">{ind.title}</h3>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-white/70 text-lg leading-relaxed mb-8">
                Restaurant and hospitality partners on the Sell + Donate pathway automatically power the GO See The City consumer app. Your surplus offers appear in real time, driving new customers through your doors before close.
              </p>
              <ul className="space-y-4 mb-10">
                {[
                  ...
                  "Every purchase reduces waste and recovers otherwise lost revenue",
            ...
            <div className="relative">
              ...
              <div className="relative bg-[#2a2a2a] rounded-3xl border border-white/10 p-8 text-center">
                ...
                <p className="text-white/60 text-sm mb-6">
                  The consumer-facing marketplace powered by Hariet.AI
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              <div className="bg-[#fdf8f4] rounded-3xl border border-[#e8e0d8] p-8">
                <div className="text-5xl mb-6">🌾</div>
                <blockquote className="text-xl font-medium text-[#2a1a10] italic leading-relaxed">
                  "Just as Harriet Tubman guided people to freedom and opportunity, Hariet.AI guides surplus food to the communities who need it most."
                </blockquote>
              </div>
            </div>
            <div className="order-1 lg:order-2">
              <h2 className="text-4xl font-bold text-[#2a1a10] mb-6">Built on a legacy of purpose</h2>
              ...
              <p className="text-[#6d412a]/80 leading-relaxed mb-8">
      ...
      {/* ── FINAL CTA ────────────────────────────── */}
      <section className="py-24 bg-[#2a1a10] text-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl sm:text-5xl font-bold mb-6">
            Ready to divert your surplus?
          </h2>
          <p className="text-white/70 text-lg mb-10 leading-relaxed">
            Whether you're a stadium feeding thousands after a game or a restaurant closing for the night — Hariet.AI has a pathway for your operation. Get set up in days, not months.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/contact"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-[#6d412a] text-white font-semibold hover:bg-[#5a3422] transition shadow-lg text-lg"
            >
              Get Started <ArrowRight className="w-5 h-5" />
            </Link>
            <Link
              to="/login"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl border border-white/20 text-white font-semibold hover:bg-white/5 transition text-lg"
            >
              Log In to Dashboard
            </Link>
          </div>
